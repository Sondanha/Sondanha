...
프로그래밍 공부와 AI 전반을 탐구하고, LLM·AI 기반의 **서비스 구현**을 목표로 합니다. 
주 언어는 **파이썬**이지만 개발 목적에 따라 **다양한 언어와 프레임워크**를 사용합니다!
...
> 논문을 쉽게 요약 및 [시각 자료 자동 생성](https://github.com/group5-ocr/paper-viz)

<br>

### 👾 나의 관심사

➡️ 여기서 [dandan의 Velog 시리즈](https://velog.io/@son-dan-ha/series)를 구경하세요!
